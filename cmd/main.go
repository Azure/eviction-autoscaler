...
func main() {
	...
	enabledByDefault, err := k8senv.GetBool("ENABLED_BY_DEFAULT", false)
	if err != nil {
	...
	pdbCreate, err := k8senv.GetBool("PDB_CREATE", false)
	if err != nil {
	...
	pdbMaxUnavailableAdoption, err := k8senv.GetBool("PDB_MAX_UNAVAILABLE_ADOPTION", false)
	if err != nil {
